...
# MaSanté+ : Votre Assistant Personnalisé pour la Gestion du Diabète de Type 2

MaSanté+ est une application web moderne conçue pour aider les utilisateurs à gérer leur diabète de type 2 au quotidien. Elle intègre une planification de repas intelligente assistée par IA, un suivi des médicaments, et une interface utilisateur intuitive pour une meilleure prise en charge de la santé.
...
L'objectif principal de MaSanté+ est de fournir aux personnes atteintes de diabète de type 2 des outils simples et efficaces pour :
- **Planifier leurs repas** : Générer des plans de repas personnalisés, équilibrés et adaptés à leurs besoins spécifiques, en tenant compte de leurs préférences alimentaires et des dernières recommandations nutritionnelles.
...
- **Planification de Repas par IA** :
    ...
    - Basé sur des recommandations nutritionnelles pour le diabète de type 2.
...
git clone git@github.com:VOTRE_NOM_UTILISATEUR/VOTRE_NOM_DE_DEPOT.git
